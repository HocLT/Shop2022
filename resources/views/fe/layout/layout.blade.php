...
<head>
	...
	<link rel="stylesheet" href="{{ asset('/fe/css/chosen.min.css') }}">
	<link rel="stylesheet" href="{{ asset('/fe/css/style.css') }}">
	<link rel="stylesheet" href="{{ asset('/fe/css/color-01.css') }}">
</head>
<body class="home-page home-01 ">
	...
	<script src="{{ asset('/fe/js/jquery-1.12.4.minb8ff.js?ver=1.12.4') }}"></script>
	<script src="{{ asset('/fe/js/jquery-ui-1.12.4.minb8ff.js?ver=1.12.4') }}"></script>
	<script src="{{ asset('/fe/js/bootstrap.min.js') }}"></script>
	<script src="{{ asset('/fe/js/jquery.flexslider.js') }}"></script>
	<script src="{{ asset('/fe/js/chosen.jquery.min.js') }}"></script>
