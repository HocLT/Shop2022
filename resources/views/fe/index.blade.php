  ...
  <div class="wrap-main-slide">
    <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
      <div class="item-slide">
        <img src="{{ asset('/fe/images/main-slider-1-1.jpg') }}" alt="" class="img-slide">
      ...
      <div class="item-slide">
        <img src="{{ asset('/fe/images/main-slider-1-2.jpg') }}" alt="" class="img-slide">
      ...
      <div class="item-slide">
        <img src="{{ asset('/fe/images/main-slider-1-3.jpg') }}" alt="" class="img-slide">
  ...
  <div class="wrap-banner style-twin-default">
    <div class="banner-item">
      <a href="#" class="link-banner banner-effect-1">
        <figure><img src="{{ asset('/fe/images/home-1-banner-1.jpg') }}" alt="" width="580" height="190"></figure>
      </a>
    </div>
    <div class="banner-item">
      <a href="#" class="link-banner banner-effect-1">
        <figure><img src="{{ asset('/feassets/images/home-1-banner-2.jpg') }}" alt="" width="580" height="190"></figure>
      </a>
    </div>
  </div>
    ...
    <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
      ...
      <div class="product product-style-2 equal-elem ">
        <div class="product-thumnail">
          <a href="{{ Route('details', $item->slug) }}" title="{{ $item->name }}">
            <figure><img src="images/{{ $item->image }}" width="800" height="800" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
          </a>
        ...
        <div class="product-info">
          <a href="{{ Route('details', $item->slug) }}" class="product-name"><span>{{ $item->name }}</span></a>
